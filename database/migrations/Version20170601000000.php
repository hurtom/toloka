...
class Version20170601000000 extends AbstractMigration
{
    ...
    public function up(Schema $schema)
    {
        ...
        // bb_flags
        $this->addSql('ALTER TABLE bb_flags
            CHANGE flag_id flag_id INT UNSIGNED AUTO_INCREMENT NOT NULL,
            ENGINE = InnoDB');
        ...
        // bb_search_wordlist
        $this->addSql('ALTER TABLE bb_search_wordlist
            CHANGE word_text word_text VARCHAR(50) NOT NULL,
            CHANGE word_id word_id INT UNSIGNED NOT NULL,
            CHANGE word_common word_common TINYINT(1) DEFAULT \'0\' NOT NULL,
            ENGINE = InnoDB');
